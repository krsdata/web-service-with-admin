...
interface StateableInterface {
    ...
    const STATE_INVENTORY_ON_HOLD = 'Modules-on-hold';
    const STATE_INVENTORY_RELEASED = 'Modules-released';
    const STATE_INVENTORY_RELEASED_PARTIAL = 'inventory-released-partial';
    const STATE_INVENTORY_REMOVED = 'Modules-removed';
    const STATE_INVENTORY_REMOVED_PARTIAL = 'Modules-removed-partial';
    //Global states
